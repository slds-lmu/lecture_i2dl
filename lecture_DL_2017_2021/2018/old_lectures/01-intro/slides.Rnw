...
\begin{frame}   {Notation}
  \vspace{3mm}
    \makebox[4cm]{$x_1, x_2, ..., x_p$} \hspace{1cm}(input) features\par
    \makebox[4cm]{$w_1, w_2,... ,w_p$}  \hspace{1cm}weights(hidden neuron)\par
    \makebox[4cm]{$W$}   \hspace{1cm}weight matrix with dimensions $p \times m$\par
    \makebox[4cm]{$u$}  \hspace{1cm}weights(output neuron)\par
    \makebox[4cm]{$z_1, \dots, z_m$}  \hspace{1cm}hidden neurons\par
    \makebox[4cm]{$b,c$}  \hspace{1cm}bias terms \par
    \makebox[4cm]{$y$}  \hspace{1cm}true label\par
    \makebox[4cm]{$\hat{y}$}  \hspace{1cm}predicted label\par
    \makebox[4cm]{$\sigma$}  \hspace{1cm}activation function\par
    \makebox[4cm]{$y_1, \dots, y_g$}  \hspace{1cm}output units\par
    \vspace{3mm}
    \makebox[4cm]{$\alpha$}  \hspace{1cm}learning rate/ step-size\par
    \makebox[4cm]{$\lambda$}  \hspace{1cm}regularization coefficient\par
    \makebox[4cm]{$f(x)$}  \hspace{1cm}a mapping from features to labels\par
    \makebox[4cm]{$\tau$}  \hspace{1cm}activation function(output layer)\par
    
\end{frame}

\begin{frame}   {Notation}
    \makebox[4cm]{$y = (y_1, \dots, y_g)$}  \hspace{1cm}output units\par
    \makebox[4cm]{$\nabla \fx$}  \hspace{1cm}gradient of $f(x)$\par
    \makebox[4cm]{$\Lxy$}  \hspace{1cm}loss function\par
    \makebox[4cm]{$diag(a)$}  \hspace{1cm}diagonal matrix\begin{footnotesize}($a$ on the diagonal)\end{footnotesize}\par
    \makebox[4cm]{$\Pen$}  \hspace{1cm}parameter norm penalty\par
    ...
    \makebox[4cm]{$U$}  \hspace{1cm}matrix of hidden-to-output weights\par
...
% \end{vbframe}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{vbframe}{Revision: Gradient descent}
  \begin{itemize}
    \item Let $\fx$ be an arbitrary, differentiable, unrestricted target function, which we want to minimize.
      \begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{vbframe}{Example: Gradient descent and convex function}
  \begin{center}
