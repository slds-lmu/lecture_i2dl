...
\begin{frame}{Undercomplete Autoencoders}
  ...
  \only<2>{
    \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{plots/AE_naive2.png}
    \end{figure}
  }
  \only<3>{
    \begin{itemize}
  ...
  \vspace*{-0.3cm}
    ...
    \centering
<<<<<<< HEAD
    \includegraphics[width=0.4\textwidth]{plots/AE_undercomplete.png}
=======
...
<<<<<<< HEAD
    \centering
    \includegraphics[width=0.5\textwidth]{plots/manifold1.png}
=======
    \begin{center}
