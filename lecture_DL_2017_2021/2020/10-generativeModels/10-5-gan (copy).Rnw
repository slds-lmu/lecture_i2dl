...
\end{itemize}
\begin{figure}
%\includegraphics[width=0.22\framewidth]{plots/VAE.png}
...
\begin{frame} {What Is a GAN?}
    \begin{figure}
    \centering
    \scalebox{0.52}{\includegraphics{plots/GAN.png}}
    \end{figure}
    \begin{itemize}
...
\begin{figure}
\centering
\scalebox{0.4}{\includegraphics{plots/GAN.png}}
\end{figure}
\begin{itemize}
...
\tiny{\\Source: Goodfellow et al (2017)}
\end{figure}
\begin{itemize}
