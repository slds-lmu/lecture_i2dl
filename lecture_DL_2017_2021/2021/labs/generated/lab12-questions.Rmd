...
optim = optimizer_adam(
  # TODO set the parameters appropriately
)
...
for(i in 1:2500) {
  for (k in 1:5) {
    # TODO get a random batch of images
    
    # TODO create a matrix of normally-distributed noise
  
    # TODO use the generator to generate images from the noise
    
    dloss = (
      # TODO perform a step of SGD on the discriminator
    )
  }

  gloss = (
    # TODO perform a step of SGD on the entire GAN using noise as input
  )
