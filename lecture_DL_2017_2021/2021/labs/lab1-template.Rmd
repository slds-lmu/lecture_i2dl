...
The _convex hull_ of a set of points is the smallest convex polygon that encloses them. In our case, the convex hull of $x_2,\ldots,x_5$ is a square with those points as vertices.
