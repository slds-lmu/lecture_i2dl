...
ws = (
  #!hwbegin TODO compute the optimal regression parameters
...
ws2 = matrix(
  #!hwbegin TODO fill in  the weights for the second layer
  c(-1, -1), nrow = 2, ncol = 1, byrow = TRUE
  #!hwend
)

bs2 = (
  #!hwbegin TODO fill in the biases for the second layer
...
sigmoid = function(x) {
  #!hwbegin TODO compute the sigmoid activation on x
  1 / (1 + exp(-x))
  #!hwend
}

predictions = (
  #!hwbegin TODO use the weights and biases to compute the output of the network
...
binary_crossentropy = function(y_true, y_predicted) {
  #!hwbegin TODO compute the loss between the predictions and ys
