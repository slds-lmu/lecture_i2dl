...
\lecturechapter{5}{Convolutional Neural Networks I}
...
\begin{vbframe}{Convolutional neural networks}
  \begin{itemize}
    ...
    \item Since 2012, the state-of-the-art for many machine vision tasks.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{vbframe} {CNNs - A First Glimpse}
    \begin{figure}
        \centering
        \includegraphics[width=10cm]{plots/01_introduction/alexnet.png}
         \caption{VGG-16 architecture (Simonyan et. al , 2014.)}
    \end{figure}
\framebreak
    \begin{itemize}
    ...
    \item Therefore, it contains different building blocks :
        \begin{itemize}
            \item Input layer : contains the input (-image) as data matrices.
            \item \textbf{Convolutions} : extract feature maps from a previous input.
            \item \textbf{Pooling} : reduce the dimensionality of any input and filter robust features.
            \item Fully connected layer : standard layer that connects feature map elements with the output neurons.
            \item Softmax : squashes output values to probability scores.
        \end{itemize}
    \end{itemize}
\end{vbframe}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\framebreak
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{plots/01_introduction/object_localization.png}
...
\framebreak
    \begin{itemize}
        ...
        $$
            ...
            \end{bmatrix} * A = S_x * A
        $$
        \item where the filter matrix $S_x$ consists of the product of an \textbf{averaging} and a \textbf{differentiation} kernel : 
        $$
...
\framebreak
    \begin{itemize}
        ...
        $$
            G = \sqrt{G_x^2 + G_y^2}
        $$
        \item These matrix operations were used to create the filtered Albert.
    \end{itemize}
\end{vbframe}
...
\frametitle{Filters to extract features}
    ...
    \begin{itemize}
        ...
        \only<3>{\item $G_x$ enables us to to detect vertical edges!}
        \only<4>{\item[]}
        \only<5>{\item[]
        \vspace{-0.8cm}
        \begin{alignat*}{3}
...
\begin{frame}{Sparse interactions}
  \begin{itemize}
    ...
    \end{itemize}
    \item When processing images, it is more likely that features occur at specific locations in the input.
...
\frametitle{Equivariance to translation}
  ...
  \begin{itemize}
    ...
    \only<4>{\item It is literally able to find it anywhere!
    This is induced by a property called \textbf{equivariance to translation}.
...
\section{Variants of convolutions}
...
\frametitle{Padding}
  ...
  \begin{itemize}
    ...
    \only<2>{\item[] The filter is only allowed to move inside of the input.}
  ...
  \only<3>{\includegraphics[width=10cm]{plots/05_conv_variations/valid/valid4.png}}%
...
\frametitle{\enquote{Same} versus \enquote{valid} padding}

\begin{figure}
\center
\includegraphics[width=.6\textwidth]{plots/zeropadding.png}
\caption{Goodfellow, \emph{et al.}, 2016, ch.~9}
\end{figure}
...
\frametitle{Strides}
  ...
  \only<3>{\includegraphics[width=9cm]{plots/05_conv_variations/strides/strides4.png}}%
...
\begin{frame}{Nonlinearity in feature maps}
    \begin{itemize}
        ...
        \item Typically rectified linear units (ReLU) are used in CNNs:
            ...
            \end{itemize}
        \item There exist many variants of the ReLU (Leaky ReLU, ELU, PReLU, ...).
    \end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frametitle{Max Pooling}
  ...
  \begin{itemize}
    ...
    \only<2>{\item To obtain actual downsampling, we typically choose a stride of 2, which will halve the dimensions for a filter of size 2.}
...
\begin{figure}
\center
\includegraphics[width=.6\textwidth]{plots/maxpooling.png}
\caption{Goodfellow, \emph{et al.}, 2016, ch.~9}
\end{figure}
...
\frametitle{Convolution and Pooling as infinitely strong prior}
...
\item Insights from this perspective:
convolution and pooling can cause overfitting.
\end{itemize}
...
\begin{vbframe}{CNNs - Perspective III}
    ...
    \begin{itemize}
        ...
        \item Awesome interactive visualization (by Adam Harley) : \href{http://scs.ryerson.ca/~aharley/vis/}{click here}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=11cm]{plots/application/cifar10_net.png}
        \caption{Structure of a CNN architecture for classification on the Cifar10 dataset. (MLP layer = dense layer)}
    \end{figure}   
\end{vbframe}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{vbframe}{Application - Image Colorization}
    \begin{itemize}
        \item We want to learn a deep net that is able to map a grayscale image to a colourized image.
        ...
        \end{itemize}
        \item Very comprehensive material on the method is provided on \href{http://richzhang.github.io/colorization/}{the author's website (click here)}.
    \end{itemize}
\framebreak
    \begin{figure}
        \centering
...
\framebreak
    ...
    \begin{itemize}
        ...
        \item More on this in the next lecture!
    \end{itemize}
% \framebreak
%     \begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibitem[Krizhesvky Alex et. al , 2012]{28} Krizhesvky Alex, Sutskever, Ilya and Geoffrey E. Hinton (2012)
\newblock Imagenet classification with deep convolutional neural networks
\newblock \emph{\url{https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibitem[He Kaiming et. al. , 2015]{30} Kaiming He, Zhang, Xiangyu, Ren, Shoaqing and Jian Sun (2015)
