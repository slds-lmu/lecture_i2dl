...
<br><br><br>
<br>
Sarah Deubner, Julius Kobialka, Emanuel Sommer
<br>
...
## Labs
 ...
 - Exercises and solutions for the week will be posted on Moodle on Thursdays
 - We will discuss the solutions of the previous week. We expect you to **come prepared**!
...
## Practice-oriented Exercises
 ...
 - Question and solutions are provided both in R & Python
   - We will present the solutions in either R or Python depending on the topic, but you are free to use and ask questions about the other version
   - We will indicate which version we will present on Moodle
 - Purpose:
