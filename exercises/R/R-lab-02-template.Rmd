---
title: "Deep Learning Lab 1 | Summer Term 2026"
...
In this exercise, we are going to create a neural network with two hidden layers and threshold activation that can correctly separate the cyan region from the rest in the plot below. We will do this by composing linear classifiers.
...
plot_decision_boundary_first_hidden(0.5, -2, 1)
```
...
plot_decision_boundary_second_hidden(-0.5, 0, 1, -1, -1)
```
