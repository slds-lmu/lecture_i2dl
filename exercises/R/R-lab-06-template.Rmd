---
title: "Deep Learning Lab 5 | Summer Term 2026"
author: "Sarah Deubner, Julius Kobialka, Emanuel Sommer"
output: pdf_document
---
...
compile(
  #!hwbegin TODO compile the model
  original_model,
  optimizer = "rmsprop",
  loss = "binary_crossentropy",
  metrics = c("accuracy")
...
bigger_model_hist = fit(
  #!hwbegin TODO fit the big network
  bigger_model,
  partial_x_train,
  partial_y_train,
  batch_size = 512,
