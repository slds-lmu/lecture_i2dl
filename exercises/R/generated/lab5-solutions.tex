...
\NormalTok{    string\_x }\OtherTok{=}\NormalTok{ (}
      \FunctionTok{to.string}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{    )}
    
\NormalTok{    string\_y }\OtherTok{=}\NormalTok{ (}
      \FunctionTok{to.string}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y)}
\NormalTok{    )}
    
    \FunctionTok{c}\NormalTok{(}
      \StringTok{"("}\NormalTok{,}
\NormalTok{      string\_x, operator, string\_y,}
      \StringTok{")"}
\NormalTok{    )}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"tanh"}\NormalTok{, }\StringTok{"exp"}\NormalTok{, }\StringTok{"log"}\NormalTok{)) \{}
    \FunctionTok{c}\NormalTok{(}
\NormalTok{      node}\SpecialCharTok{$}\NormalTok{op, }\StringTok{"("}\NormalTok{, }\FunctionTok{to.string}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x), }\StringTok{")"}
\NormalTok{    )}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
...
\NormalTok{    value\_x }\OtherTok{=}\NormalTok{ (}
      \FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, var\_values)}
\NormalTok{    )}
    
\NormalTok{    value\_y }\OtherTok{=}\NormalTok{ (}
      \FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y, var\_values)}
\NormalTok{    )}
...
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"sub"}\NormalTok{) \{}
    \FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, var\_values) }\SpecialCharTok{{-}} \FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y, var\_values)}
\NormalTok{  \}}
...
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"tanh"}\NormalTok{) \{}
    \FunctionTok{tanh}\NormalTok{(}\FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, var\_values))}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"exp"}\NormalTok{) \{}
    \FunctionTok{exp}\NormalTok{(}\FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, var\_values))}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"log"}\NormalTok{) \{}
    \FunctionTok{log}\NormalTok{(}\FunctionTok{compute}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, var\_values))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \FunctionTok{stop}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"unknown node: "}\NormalTok{, node}\SpecialCharTok{$}\NormalTok{op))}
\NormalTok{  \}}
...
\NormalTok{  diff\_x }\OtherTok{=}\NormalTok{ (}
    \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, variable)}
\NormalTok{  )}
\NormalTok{  diff\_y }\OtherTok{=}\NormalTok{ (}
    \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y, variable)}
\NormalTok{  )}
...
\NormalTok{differentiate.mul }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node, variable) \{}
  \FunctionTok{n.sum}\NormalTok{(}
    \FunctionTok{n.mul}\NormalTok{(}\FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, variable), node}\SpecialCharTok{$}\NormalTok{y),}
    \FunctionTok{n.mul}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, }\FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y, variable))}
\NormalTok{  )}
\NormalTok{\}}

\NormalTok{differentiate.div }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node, variable) \{}
  \CommentTok{\# we differentiate only once and re{-}use this part of the graph}
\NormalTok{  dy }\OtherTok{=} \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y, variable)}
  
  \FunctionTok{n.div}\NormalTok{(}
    \FunctionTok{n.sub}\NormalTok{(}
       \FunctionTok{n.mul}\NormalTok{(}
          \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, variable),}
\NormalTok{          node}\SpecialCharTok{$}\NormalTok{y),}
       \FunctionTok{n.mul}\NormalTok{(}
\NormalTok{          node}\SpecialCharTok{$}\NormalTok{x,}
\NormalTok{          dy)),}
    \FunctionTok{n.mul}\NormalTok{(}
\NormalTok{       node}\SpecialCharTok{$}\NormalTok{y,}
\NormalTok{       node}\SpecialCharTok{$}\NormalTok{y))}
...
\NormalTok{differentiate.tanh }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node, variable) \{}
  \CommentTok{\# (1 {-} tanh(x)\^{}2) * differentiate(x)}
\NormalTok{  tx }\OtherTok{=} \FunctionTok{n.tanh}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
  \FunctionTok{n.mul}\NormalTok{(}
    \FunctionTok{n.sub}\NormalTok{(}
       \FunctionTok{n.const}\NormalTok{(}\DecValTok{1}\NormalTok{),}
       \FunctionTok{n.mul}\NormalTok{(}
...
\NormalTok{differentiate.exp }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node, variable) \{}
  \FunctionTok{n.mul}\NormalTok{(}
     \FunctionTok{n.exp}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x),}
     \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, variable))}
\NormalTok{\}}


\NormalTok{differentiate.log }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node, variable) \{}
  \CommentTok{\# (1 / x) * differentiate(x)}
   \FunctionTok{n.div}\NormalTok{(}
      \FunctionTok{differentiate}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x, variable),}
\NormalTok{      node}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{\}}
...
\NormalTok{  simple\_x }\OtherTok{=}\NormalTok{ (}
    \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{  )}
\NormalTok{  simple\_y }\OtherTok{=}\NormalTok{ (}
    \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y)}
\NormalTok{  )}
...
\NormalTok{  sx }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{  sy }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y)}
  
  \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sx)) \{}
    \CommentTok{\# 0 {-} y = {-}1 * y}
    \FunctionTok{n.mul}\NormalTok{(}\FunctionTok{n.const}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{), sy)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sy)) \{}
    \CommentTok{\# x {-} 0 = 0}
\NormalTok{    sx}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"} \SpecialCharTok{\&\&}\NormalTok{ sy}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"}\NormalTok{) \{}
    \CommentTok{\# perform the operation if possible}
    \FunctionTok{const}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{{-}}\NormalTok{ sy}\SpecialCharTok{$}\NormalTok{value)}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.sub}\NormalTok{(sx, sy)}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{  sy }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y)}
  ...
  \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sx) }\SpecialCharTok{||} \FunctionTok{is.zero}\NormalTok{(sy)) \{}
    \CommentTok{\# 0 * y = x * 0 = 0}
    \FunctionTok{n.const}\NormalTok{(}\DecValTok{0}\NormalTok{)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.one}\NormalTok{(sx)) \{}
    \CommentTok{\# 1 * y = y}
\NormalTok{    sy}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.one}\NormalTok{(sy)) \{}
    \CommentTok{\# x * 1 = x}
\NormalTok{    sx}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"} \SpecialCharTok{\&\&}\NormalTok{ sy}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"}\NormalTok{) \{}
    \CommentTok{\# perform the operation if possible}
    \FunctionTok{n.const}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{*}\NormalTok{ sy}\SpecialCharTok{$}\NormalTok{value)}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.mul}\NormalTok{(sx, sy)}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{  sy }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{y)}
  ...
  \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sx)) \{}
    \CommentTok{\# 0 / y = 0 (even when y = 0)}
    \FunctionTok{n.const}\NormalTok{(}\DecValTok{0}\NormalTok{)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sy)) \{}
    \CommentTok{\# cannot do x / 0 }
    \FunctionTok{stop}\NormalTok{(}\StringTok{"division by zero"}\NormalTok{)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.one}\NormalTok{(sy)) \{}
    \CommentTok{\# x / 1 = x}
\NormalTok{    sx}
...
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.div}\NormalTok{(sx, sy)}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{  sx }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
  \ControlFlowTok{if}\NormalTok{(}\FunctionTok{is.zero}\NormalTok{(sx)) \{}
    ...
    \FunctionTok{n.const}\NormalTok{(}\DecValTok{0}\NormalTok{)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"}\NormalTok{) \{}
    \CommentTok{\# perform the operation if possible}
    \FunctionTok{n.const}\NormalTok{(}\FunctionTok{tanh}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{value))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.tanh}\NormalTok{(sx)}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"}\NormalTok{) \{}
    \CommentTok{\# perform the operation if possible}
    \FunctionTok{n.const}\NormalTok{(}\FunctionTok{exp}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{value))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.exp}\NormalTok{(sx)}
\NormalTok{  \}}
\NormalTok{\}}

\NormalTok{simplify.log }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(node) \{}
\NormalTok{  sx }\OtherTok{=} \FunctionTok{simplify}\NormalTok{(node}\SpecialCharTok{$}\NormalTok{x)}
  \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"} \SpecialCharTok{\&\&}\NormalTok{ sx}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{\textless{}=} \DecValTok{0}\NormalTok{) \{}
    \CommentTok{\# cannot compute log(x) for x \textless{}= 0}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"logarithm of non{-}positive number"}\NormalTok{)}
\NormalTok{  \}}
  \ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{op }\SpecialCharTok{==} \StringTok{"const"}\NormalTok{) \{}
    \CommentTok{\# perform the operation if possible}
    \FunctionTok{n.const}\NormalTok{(}\FunctionTok{log}\NormalTok{(sx}\SpecialCharTok{$}\NormalTok{value))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# cannot simplify further}
    \FunctionTok{n.log}\NormalTok{(sx)}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{    losses[[e }\SpecialCharTok{*} \DecValTok{5} \SpecialCharTok{+}\NormalTok{ j]] }\OtherTok{=}\NormalTok{ (}
      \FunctionTok{compute}\NormalTok{(loss, values)}
\NormalTok{    )}
...
\includegraphics{lab5-solutions_files/figure-latex/unnamed-chunk-15-1.pdf}
