...
2. 
    ...
    2.  - Vector-wise similarity/closeness between the elements in Q and K. 
        - Intuitively: Per word (embedding) q, how much does an respective element from k relate to q for the given context. How much does k help us to understand what q is about? 
