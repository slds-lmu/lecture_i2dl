...
\newcommand{\learninggoals}{
  ...
  \item Manifold learning with AEs 
}
    ...
    %    Data is concentrated around a low-dimensional \textit{manifold} or a small set of such manifolds
        ...
        \end{itemize}
          \begin{figure}[h]
                ...
                \caption{(Goodfellow et al., 2016)%Data sampled from a distribution in a 2D space that is actually concentrated near a 1D manifold.
                }
            \end{figure}
           \end{itemize}    
       \framebreak
