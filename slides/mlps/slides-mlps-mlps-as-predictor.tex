...
\begin{figure}
\centering
\scalebox{0.25}{\includegraphics{figure/cartesian.png}}
\end{figure}
...
\begin{figure}
\centering
\scalebox{0.25}{\includegraphics{figure/polar.png}}
\end{figure}
\end{itemize}
\framebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\scalebox{0.65}{\includegraphics{figure/newrep_n_f.png}}
\end{figure}
\end{itemize}
\end{vbframe}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\only<1>{\scalebox{.8}{\includegraphics{figure/singlelay_1.png}}}
\only<2>{\scalebox{.8}{\includegraphics{figure/singlelay_2.png}}}
\only<3>{\scalebox{.8}{\includegraphics{figure/singlelay_3.png}}}
\only<4>{\scalebox{.8}{\includegraphics{figure/singlelay_4.png}}}
...
\begin{figure}
\centering
\only<1>{\scalebox{.83}{\includegraphics{figure/singlelay_6.png}}}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\only<1>{\scalebox{.83}{\includegraphics{figure/singlelay_7.png}}}
\only<2>{\scalebox{1}{\includegraphics{figure/singlelay_8.png}}}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\only<1>{\scalebox{.8}{\includegraphics{figure/singlelay_9.png}}}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{blocki}
\begin{figure}
\scalebox{1}{\includegraphics{figure_man/relu.png}}
\end{figure}
\framebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{blocki}
\begin{figure}
\scalebox{1}{\includegraphics{figure_man/tanh.png}}
\end{figure}
\framebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
