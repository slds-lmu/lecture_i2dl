...
\begin{frame} {Single Hidden Layer Networks: Example}
  ...
  \begin{figure}
    \centering
      \only<1>{\scalebox{1}{\includegraphics{figure/sinlay_one.png}}}
      \only<2>{\scalebox{1}{\includegraphics{figure/sinlay_two.png}}}
      \only<3>{\scalebox{1}{\includegraphics{figure/sinlay_three.png}}}
      \only<4>{\scalebox{1}{\includegraphics{figure/sinlay_four.png}}}
      \only<5>{\scalebox{1}{\includegraphics{figure/sinlay_five.png}}}
      \only<6>{\scalebox{1}{\includegraphics{figure/sinlay_six.png}}}
  \end{figure}
  \begin{figure}
    \centering
  \end{figure}
...
\begin{frame} {Single Hidden Layer Networks: Example}
  ...
  \begin{figure}
    \centering
    \only<1>{\scalebox{1}{\includegraphics{figure/sinlay_seven.png}}}
    \only<2>{\scalebox{1}{\includegraphics{figure/sinlay_eight.png}}}
    \only<3>{\scalebox{1}{\includegraphics{figure/sinlay_nine.png}}}
    \only<4>{\scalebox{1}{\includegraphics{figure/sinlay_ten.png}}}
    \only<5>{\scalebox{1}{\includegraphics{figure/sinlay_eleven.png}}}
    \only<6>{\scalebox{1}{\includegraphics{figure/sinlay_twelve.png}}}
  \end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item For simplification purposes, we drop the bias terms in notation and let $\sigma = \text{id}$. Then:
    \begin{eqnarray*}
        \fx & = & \tau(\wtu^T \hidz) = \tau(\wtu^T \sigma(\Wmat^T \xv)) \\
...
\begin{frame} {Multi-class Classification}
  \begin{itemize}
    ...
    \vspace{4mm}
    \item Derivative $ \frac{\delta\tau(\mathbf{f}_{in})}{\delta \mathbf{f}_{in}} = \text{diag}(\tau(\mathbf{f}_{in})) - \tau(\mathbf{f}_{in}) \tau(\mathbf{f}_{in})^T $
    \vspace{4mm}
