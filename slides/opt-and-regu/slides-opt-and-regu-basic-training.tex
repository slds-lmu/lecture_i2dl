...
\begin{itemize}
 \item To minimize the risk, the \textbf{gradient descent} (GD) method can be used.
\end{itemize}
\end{vbframe}
...
\begin{vbframe}{Gradient descent}
  \begin{itemize}
    \item Let $\risk: \R^m \to \R$ be an arbitrary, differentiable, unrestricted function (of $\thetab \in \R^m$). \\
    \begin{footnotesize}
