% style/preamble throws error, which is why style/preamble4tex is kept
...
\vspace{-.5cm}
\begin{itemize}
\item Deep learning is a subield of  ML based on artificial neural networks.
...
\centering
\only<1>{\includegraphics[width=0.7\textwidth]{figure/bird1.pdf}}
\only<1>{\\ \footnotesize{}}
\only<2>{\includegraphics[width=0.7\textwidth]{figure/bird2.pdf}}
\only<2>{\\ \footnotesize{}}
\only<3>{\includegraphics[width=0.7\textwidth]{figure/bird3.pdf}}
\only<3>{\\ \footnotesize{}}
\only<4>{\includegraphics[width=0.7\textwidth]{figure/bird4.pdf}}
\only<4>{\\ \footnotesize{}}
\end{overlayarea}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\scalebox{0.8}{\includegraphics{figure/maskrcnn.png}}
\\
...
\begin{figure}
\centering
\scalebox{.8}{\includegraphics{figure/segmentation.png}}
\\
...
\begin{figure}
\centering
\scalebox{.9}{\includegraphics{figure/nmt.png}}
\end{figure}
...
\begin{figure}
\centering
\scalebox{.9}{\includegraphics{figure/speech_goog.jpg}}
\end{figure}
