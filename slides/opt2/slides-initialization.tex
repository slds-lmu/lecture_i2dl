...
\end{itemize}
  ...
  \vspace{-0.5cm}
    \centering
      \scalebox{0.4}{\includegraphics{figure/spiral_planar_data/data.png}}
      \caption{Simulated spiral planar data set with two classes (Ghatak, 2019).}
  \end{figure}
  \framebreak
  \begin{figure}
    \centering
      \scalebox{1}{\includegraphics{figure/spiral_planar_data/zero.png}}
...
neuron (Ghatak, 2019).}
  ...
  \begin{figure}
    \centering
      \scalebox{1}{\includegraphics{figure/spiral_planar_data/random.png}}
  ...
  \begin{figure}
    \centering
      \scalebox{1}{\includegraphics{figure/spiral_planar_data/he.png}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibitem[(Ghatak, 2019)]{1} Ghatak, A. (2019). \textit{Deep learning with R}. Springer Singapore. 
