...
\begin{frame} {Momentum: Illustration}
  ...
  \begin{figure}
    \centering
      \scalebox{0.90}{\includegraphics{figure/moment_vis2.png}}
...
\begin{vbframe}{Momentum vs. Nesterov Momentum}
  ...
  \captionsetup{font=footnotesize,labelfont=footnotesize, labelfont = bf}
    \centering
      \scalebox{0.90}{\includegraphics{figure/nesterov_momentum.png}}
...
\begin{frame} {Learning Rate}
  \begin{itemize}
    ...
    \begin{figure}
    \centering
      \scalebox{0.7}{\includegraphics{figure/lr_jh.png}}
...
\end{minipage}
  \begin{figure}
  \centering
    \scalebox{0.95}{\includegraphics[width=8cm]{figure/weight_decayy.png}}
  \end{figure}
\end{vbframe}
...
\begin{frame} {Cyclical Learning Rates}
  \begin{itemize}
    ...
    \begin{figure}
      \centering
        \scalebox{1}{\includegraphics{figure/cyc_triangular.png}}
...
\begin{frame} {Cyclical Learning Rates}
  \begin{itemize}
    ...
    \begin{figure}
      \centering
        \scalebox{0.6}{\includegraphics{figure/cyc_cosine.png}}
        \tiny{\\Credit: Hafidz Zulkifli}
    \end{figure}
  \end{itemize}
\end{frame}
...
\captionsetup{font=footnotesize,labelfont=footnotesize, labelfont = bf}
    \begin{center}
    \vspace{-1cm}
      \href{https://giphy.com/embed/SJVFO3IcVC0M0}{\includegraphics[width = .49\textwidth]{figure/sattle_point2-50.png}}
      \href{https://giphy.com/embed/SJVFO3IcVC0M0}{\includegraphics[width = .49\textwidth]{figure/sattle_point2-150.png}}
...
\begin{frame} {Batch Normalization: Illustration}
  ...
  \end{itemize}
    \begin{figure}
    \centering
      \scalebox{0.32}{\includegraphics{figure/batchy.png}}
...
\begin{frame} {Batch Normalization}
  ...
  \begin{figure}
    \centering
      \scalebox{0.6}{\includegraphics{figure/bn_effect.png}}
  \end{figure}
\end{frame}
